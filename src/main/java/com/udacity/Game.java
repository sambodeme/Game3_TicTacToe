...
public class Game {
    ...
    public boolean checkCharacter(char playedCharacter ){
        boolean result = false;
        //Student code goes here ...
        if ((grid[0][0]== grid[1][0])&&(grid[1][0]== grid[2][0])&&(grid[2][0]== playedCharacter)){
            result =true;
        }
        else if ((grid[0][1]== grid[1][1])&&(grid[1][1]== grid[2][1])&&(grid[2][1]== playedCharacter)){
            result =true;
        }
        else if ((grid[0][2]== grid[1][2])&&(grid[1][2]== grid[2][2])&&(grid[2][2]== playedCharacter)){
            result =true;
        }
        else if((grid[0][0]== grid[0][1])&&(grid[0][1]== grid[0][2])&&(grid[0][2]== playedCharacter)){
            result =true;
        }
        else if((grid[1][0]== grid[1][1])&&(grid[1][1]== grid[1][2])&&(grid[1][2]== playedCharacter)){
            result =true;
        }
        else if((grid[2][0]== grid[2][1])&&(grid[2][1]== grid[2][2])&&(grid[2][2]== playedCharacter)){
            result =true;
        }
        else if((grid[0][0]== grid[1][1])&&(grid[1][1]== grid[2][2])&&(grid[2][2]== playedCharacter)){
            result =true;
        }
        else if((grid[0][2]== grid[1][1])&&(grid[1][1]== grid[2][0])&&(grid[2][0]== playedCharacter)){
            result =true;
        }
        return result;
    }
    public boolean isGameOver(){
        ...
        boolean result = true;
        //Student code goes here ...
        if ((grid[0][0]== playedCharacter)||(grid[1][0]== playedCharacter)||(grid[2][0]== playedCharacter)){
            result =false;
        }
        else if ((grid[0][1]== playedCharacter)||(grid[1][1]== playedCharacter)||(grid[2][1]== playedCharacter)){
            result =false;
        }
        else if ((grid[0][2]== playedCharacter)||(grid[1][2]== playedCharacter)||(grid[2][2]== playedCharacter)){
            result =false;
        }
        return result;
    }
